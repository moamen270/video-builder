...
export const RIGS: Record<Pose, Rig> = {
  ...
  mj_lean: { lUpper: -10, lLower: -4, rUpper: 10, rLower: 4, lThigh: -6, lShin: 0, rThigh: 6, rShin: 0, head: 0, torso: 44, lift: 0, nod: 4 }, // toward the thrower (screen-left when the ball comes from the left)
