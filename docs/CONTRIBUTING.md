...
| regenerated SFX/music not audible in a new render | fixed 2026-09-19: `stageAsset` re-copies when the library file is newer or a different size. Before that `build/assets/` kept the first copy forever. |
